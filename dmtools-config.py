...
pathtofile = '/dmtools/notebooks'

c.JupyterHub.authenticator_class = 'jupyterhub.auth.PAMAuthenticator'

c.LocalAuthenticator.create_system_users = True

c.JupyterHub.bind_url = 'http://0.0.0.0:8000/dev'
...
c.JupyterHub.config_file = '/dmtools/jupyterhub/dmtools-config.py'

## File in which to store the cookie secret.
#  Default: 'jupyterhub_cookie_secret'
c.JupyterHub.cookie_secret_file = '/dmtools/jupyterhub/jupyterhub_cookie_secret'

c.ConfigurableHTTPProxy.pid_file = '/dmtools/jupyterhub/jupyterhub-proxy.pid'

c.ConfigurableHTTPProxy.command = '/usr/local/bin/configurable-http-proxy'

c.Spawner.default_url = '/tree/home/'

c.Spawner.notebook_dir='/dmtools/notebooks'
...
c.JupyterHub.data_files_path = '/dmtools/jupyterhub/env/share/jupyterhub'

## url for the database. e.g. `sqlite:///jupyterhub.sqlite`
#  Default: 'sqlite:///jupyterhub.sqlite'
c.JupyterHub.db_url = 'sqlite://///dmtools/jupyterhub/jupyterhub.sqlite'
...
c.Authenticator.admin_users = {'pauser'}
...
c.Spawner.default_url = '/dmtools/notebooks' # %U will be replaced with the username
